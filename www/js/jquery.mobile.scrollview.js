...
jQuery.widget( "mobile.scrollview", jQuery.mobile.widget, {
	options: {
		...
		overshootDuration: 125, //0,//  // Duration of the overshoot animation in msecs.
		snapbackDuration:  250, //0,//  // Duration of the snapback animation in msecs.
	...
	{ 
		...
		//this.options.showScrollBars = true;
	...
	_handleDragStart: function(e, ex, ey)
	{
		...
		if (this._hTracker)
		{
			...
			if (this._$hScrollBar)
            {
              ...
              if(cw >= vw)
              {
              this._$hScrollBar.find(".ui-scrollbar-thumb").css("visibility", "hidden");
              }
              else
              {
              this._$hScrollBar.find(".ui-scrollbar-thumb").css("visibility", "visible");
              }
		...
		if (this._vTracker)
		{
			...
			if (this._$vScrollBar)
            {
              ...
              if(ch >= vh)
              {
              this._$vScrollBar.find(".ui-scrollbar-thumb").css("visibility", "hidden");
              }
              else
              this._$vScrollBar.find(".ui-scrollbar-thumb").css("visibility", "visible");
            }
		}
